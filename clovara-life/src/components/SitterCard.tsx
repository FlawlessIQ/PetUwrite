...
export function SitterCard({ token }: { token: string }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[560px] px-5 pb-16 pt-8">
      ...
      {state === 'loading' && <p className="text-[15px] text-muted">One moment…</p>}
        ...
        <div className="card overflow-hidden">
          <div className="flex items-center gap-4 border-b border-line bg-cream/50 px-5 py-5">
            ...
            <div className="min-w-0">
              ...
              {card.species && <p className="text-[13.5px] text-muted">Looking after a {card.species}</p>}
            </div>
          </div>
          ...
          {rows.length > 0 ? (
            ...
            <p className="px-5 py-6 text-[14.5px] leading-relaxed text-muted">
