  ...
  return (
    <section className="card overflow-hidden" aria-labelledby="lumps-heading">
      <div className="border-b border-line bg-cream/50 px-5 py-4">
        ...
        <h2 id="lumps-heading" className="mt-1 font-display text-heading text-ink">
        ...
        {lumps.map((lump) => {
          ...
          return (
            <li key={lump.id} className="px-5 py-4">
              ...
              >
                <span className="text-lead font-medium text-ink">{lump.location}</span>
                ...
                <div className="mt-4">
                  ...
                  {state.pair ? (
                    <>
                      <div className="grid grid-cols-2 gap-3">
                        {state.pair.map((p, i) => (
                          <figure key={p.takenAt}>
                            ...
                            />
                            <figcaption className="mt-1 text-body-sm text-ink-2">
                      ...
                      <p className="mt-3 rounded-soft bg-sage/50 px-4 py-3 text-body-sm leading-relaxed text-deep">
                        {NO_JUDGEMENT}
                      </p>
                    </>
                  ) : (
                      ...
                      <ul className="mt-2 flex gap-2 overflow-x-auto pb-1">
                        {ordered.map((p) => (
                          <li key={p.takenAt} className="shrink-0">
                            ...
                            />
                            <p className="mt-0.5 w-20 text-caption leading-tight text-ink-2">
                  ...
                  {onUpdate && !quiet && (
                    <div className="mt-5 rounded-soft border border-line bg-cream/40 px-4 py-4">
                      <p className="text-body-lg font-medium text-ink">Take the next one</p>
                      ...
                      <button
                        type="button"
                        className="pill-primary mt-4 px-5 py-2.5 text-body-lg"
