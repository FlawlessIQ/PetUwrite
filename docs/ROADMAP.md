...
- **SPEC §1 says "75+ tests".** It is 493 unit plus 107 emulator plus nineteen end-to-end scripts, and `npm run verify:all` runs every browser suite in one command.
