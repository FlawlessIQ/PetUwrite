...
| Type scale (BACKLOG D-UI2) | 35 hand-set font sizes → 19 named §3 tokens; arbitrary sizes rejected by `verify:brand` | `built on branch type-scale, NOT deployed` 2026-09-25 — 400 of 604 uses unchanged, every measured page shorter, all 28 suites green |
