...
Coverage) and one Sev 2 (no find-a-vet on the collapse screen). BACKLOG U4–U7; defect log in the plan §8. U4 and U5 fixed and deployed from branch `uat-fixes-2` (2026-09-26); U6 and U7 open.
