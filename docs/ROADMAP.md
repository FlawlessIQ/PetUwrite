...
Coverage) and one Sev 2 (no find-a-vet on the collapse screen). BACKLOG U4–U7; defect log in the plan §8. U4 and U5 fixed on branch `uat-fixes-2`, not yet deployed.
