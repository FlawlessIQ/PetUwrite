...
> **2026-09-26:** K1–K4 are fixed and deployed (BACKLOG U1–U3, branch `uat-fixes`); the rows below record what the dry-run found. Steps that cite K1–K4 should now pass. K5 is unchanged. K6 was fixed 2026-09-26 (branch `backlog-batch`): the list is `['senior']`, and a test requires every id in it to be a real stage.
